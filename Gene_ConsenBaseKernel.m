...
dataName = 'HW2sources_uni'; 
load([path,'BaseKernel/',dataName,'_Kmatrix'],'KH1G','KH2G','KH3G','KH4G','KH5G',...
    'KH6G','KH7G','KHC','KH1M','KH2M','KH3M','KH4M','Y');



%%%%%generate consensus base kernels K1, K2, ..., Kp, ..., Kr-------generatemultiplekernel
...
clear KH1G KH2G KH3G KH4G KH5G KH6G KH7G KHC KH1M KH2M KH3M KH4M 

save([path,'ConsenBaseKernel/',dataName,'_CBKernel','.mat'],'KP','Y');
